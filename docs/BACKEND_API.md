...
**Shukayu** — це маркетплейс послуг (фріланс платформа), який з'єднує покупців (замовників) з продавцями (виконавцями).
...
Ця документація описує повну структуру backend API для проєкту shukayu. Бекенд-розробник може використовувати цю документацію для:
