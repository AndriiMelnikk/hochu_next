...
## Corpus Check
- 417 files · ~92,773 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1847 nodes · 4393 edges · 185 communities (115 shown, 70 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 4 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `da7ed9fa`
...
- sitemap.ts
- terms/page.tsx
- CompleteProposalModal.tsx
- RejectProposalModal.tsx
- input-otp.tsx
- RequestSidebar.tsx
...
3. `Button` - 55 edges
4. `routes` - 46 edges
5. `getMetadataForRoute()` - 46 edges
6. `Link()` - 30 edges
...
## Communities (185 total, 70 thin omitted)

### Community 0 - "requestSubscriptionService.ts"
Cohesion: 0.24
Nodes (8): paginationResultSchema(), RequestSubscriptionService, NotificationChannel, IGetRequestSubscriptionsRequest, ICreateRequestSubscriptionRequest, IRequestSubscription, IUpdateRequestSubscriptionRequest, RequestSubscriptionCardProps

### Community 1 - "AdminContent.tsx"
Cohesion: 0.09
Nodes (30): REQUEST_STATUS_BADGE_VARIANT, EditRequestModal(), RequestInfoProps, formatChange(), FormattedChange, AlertDialogAction, AlertDialogCancel, AlertDialogContent (+22 more)

### Community 2 - "ProposalDetailContent.tsx"
Cohesion: 0.06
Nodes (53): ArticleSection(), Props, Props, ArticleSectionData, createDefaultSections(), getIconComponent(), iconMap, parseContentToSections() (+45 more)

### Community 3 - "proposal/index.ts"
Cohesion: 0.18
Nodes (16): ProposalDetailContent(), useProposal(), createProposalSchema, getProposalsResponseSchema, proposalSchema, proposalSellerSchema, updateProposalSchema, normalizeProposalItem() (+8 more)

### Community 4 - "getLocaleFromHeaders"
Cohesion: 0.07
Nodes (28): generateMetadata(), generateMetadata(), generateMetadata(), PageProps, BlogArticlePage(), generateMetadata(), Props, generateMetadata() (+20 more)

### Community 5 - "review/index.ts"
Cohesion: 0.08
Nodes (25): useCreateReview(), useReviews(), useReviewStats(), reviewSchema, ReviewService, ICreateReviewRequest, IGetReviewsRequest, IGetReviewsResponse (+17 more)

### Community 6 - "api.ts"
Cohesion: 0.22
Nodes (5): ContactService, IContactRequest, api, failedQueue, ENDPOINTS

### Community 7 - "form.tsx"
Cohesion: 0.14
Nodes (22): ChangePasswordModal(), ChangePasswordModalProps, ForgotPasswordForm(), getForgotPasswordSchema(), getResetPasswordFormSchema(), ResetPasswordForm(), ResetPasswordFormData, ResetPasswordFormProps (+14 more)

### Community 8 - "UserRequestsList.tsx"
Cohesion: 0.20
Nodes (16): RequestContent(), useCategories(), REQUEST_STATUS_LABELS, useRequestStore, CreateRequestForm(), EditRequestForm(), RequestCard(), RequestInfo() (+8 more)
...
Cohesion: 0.11
Nodes (11): ResetPasswordContentProps, routes, RegisterButtonProps, CreateRequestButton(), CreateRequestButtonProps, breadcrumbLabels, HeroBadge, HeroBadgeProps (+3 more)
...
Cohesion: 0.16
Nodes (14): useCancelAcceptedProposal(), useUserContacts(), CancelAcceptedProposalModal(), CancelAcceptedProposalModalProps, CHANNEL_ICONS, ContactSellerModal(), ContactSellerModalProps, getHref() (+6 more)

### Community 13 - "CreateRequestForm.tsx"
Cohesion: 0.17
Nodes (15): REQUEST_URGENCY, REQUEST_URGENCY_LABELS, RegisterButton(), urgencyOptions, EditRequestFormValues, urgencyOptions, CityCombobox(), SelectContent (+7 more)

### Community 14 - "button.tsx"
Cohesion: 0.21
Nodes (10): AuthRequired(), AuthRequiredProps, GoogleSignInButton(), GoogleSignInButtonProps, LoginForm(), RegisterForm(), CategoryFilterButtonProps, Button (+2 more)

### Community 15 - "shared/utils/index.ts"
Cohesion: 0.20
Nodes (11): ACCEPTED_IMAGE_TYPES, downloadFile(), ACCEPTED_EXTENSIONS, EXT_TO_MIME, getFileExtension(), ImageUploadError, ImageUploadErrorCode, isAcceptedImageFile() (+3 more)
...
Cohesion: 0.13
Nodes (17): AdminLayout(), messagesByLocale, GoogleAuthCompleteLayout(), messagesByLocale, messagesByLocale, ResetPasswordLayout(), ForgotPasswordLayout(), messagesByLocale (+9 more)

### Community 18 - "entities/auth/index.ts"
Cohesion: 0.05
Nodes (52): CreateRequestContent(), ProfileContent(), { handlers, signIn, signOut, auth }, LS_KEYS, AuthContext, AuthContextType, AuthProvider(), useAuth() (+44 more)
...
Cohesion: 0.17
Nodes (14): EditProposalModal(), ProposalItem(), Carousel, CarouselApi, CarouselContent, CarouselContext, CarouselContextProps, CarouselItem (+6 more)

### Community 21 - "universal-pagination.tsx"
Cohesion: 0.16
...
### Community 22 - "loading.tsx"
Cohesion: 0.21
Nodes (7): Props, generateMetadata(), getRequest, Props, RequestDetailPage(), Loading, LoadingProps
...
Cohesion: 0.16
Nodes (14): GoogleAuthCompleteContent(), ProfilePage(), useAuthStore, CreateProfileModal(), EditContactChannelsForm(), EditProfileForm(), AppRouter, useLocalizedRouter() (+6 more)

### Community 26 - "devDependencies"
Cohesion: 0.12
Nodes (17): autoprefixer, eslint, eslint-config-next, eslint-plugin-prettier, @lingui/macro, devDependencies, autoprefixer, eslint (+9 more)

### Community 27 - "components.json"
Cohesion: 0.12
Nodes (16): aliases, components, hooks, lib, ui, utils, rsc, $schema (+8 more)

### Community 28 - "city-combobox.tsx"
Cohesion: 0.24
Nodes (11): CascadingSelectProps, CityComboboxProps, Command, CommandDialogProps, CommandEmpty, CommandGroup, CommandInput, CommandItem (+3 more)
...
Cohesion: 0.13
Nodes (15): axios, dependencies, axios, @radix-ui/react-popover, @radix-ui/react-scroll-area, @radix-ui/react-select, @radix-ui/react-slot, react-dom (+7 more)

### Community 32 - "SupportContent.tsx"
Cohesion: 0.26
Nodes (8): JsonLd(), JsonLdProps, getFaqPageJsonLd(), AccordionContent, AccordionItem, AccordionTrigger, Faq(), FAQ_KEYS

### Community 33 - "uploadFile.ts"
Cohesion: 0.21
Nodes (9): AI_BOTS, DISALLOW, createUploadFormData(), getUploadHeaders(), parseUploadResponse(), refreshAccessToken(), uploadFile(), LS_KEYS (+1 more)

### Community 34 - "notificationService.ts"
Cohesion: 0.28
Nodes (9): INotification, NotificationCategory, IGetNotificationsRequest, IPaginationResult, MapNotificationFiltersInput, CATEGORY_VALUES, inferNotificationCategory(), normalizeNotification() (+1 more)
...
### Community 38 - "EditProposalForm.tsx"
Cohesion: 0.17
Nodes (15): PROPOSAL_DELIVERY_TIME, PROPOSAL_DELIVERY_TIME_LABELS, PROPOSAL_WARRANTY, PROPOSAL_WARRANTY_LABELS, useCreateProposal(), useUpdateProposal(), CreateProposalForm(), CreateProposalFormProps (+7 more)
...
### Community 41 - "cn"
Cohesion: 0.10
Nodes (18): CategoryFilterButton(), cn(), Checkbox, CommandShortcut(), HoverCardContent, RadioGroup, RadioGroupItem, ResizableHandle() (+10 more)
...
### Community 47 - "AcceptProposalModal.tsx"
Cohesion: 0.24
Nodes (8): useAcceptProposal(), useCancelProposal(), AcceptProposalModal(), AcceptProposalModalProps, CancelProposalModal(), CancelProposalModalProps, DialogDescription, DialogFooter()
...
### Community 56 - "config.ts"
Cohesion: 0.29
Nodes (10): OpengraphImage(), size, isLocale(), locales, localizeHref(), resolveLocale(), switchLocaleInPathname(), config (+2 more)

### Community 57 - "notificationSchema.ts"
Cohesion: 0.19
Nodes (10): categoryPreferenceSchema, newRequestsPreferenceSchema, notificationCategorySchema, notificationChannelSchema, notificationPreferencesSchema, notificationSchemaRaw, requestSubscriptionSchema, NotificationPreferenceService (+2 more)

### Community 58 - "request/index.ts"
Cohesion: 0.12
Nodes (25): useCancelRequest(), useCreateRequest(), useLatestRequests(), useRequest(), useRequests(), createRequestSchema, getRequestsResponseSchema, requestBuyerSchema (+17 more)
...
Cohesion: 0.22
Nodes (12): useDeleteRequestSubscription(), useNotificationPreferences(), useRequestSubscriptions(), useUpdateNotificationPreferences(), RequestSubscriptionCard(), AccountMessagesSection(), BUYER_CATEGORIES, NotificationSettingsContent() (+4 more)
...
### Community 69 - "route-metadata.ts"
Cohesion: 0.33
Nodes (6): defaultMetadata, routeMetadata, metadataByLocale, OG_LOCALE, defaultMetadata, routeMetadata

### Community 70 - "CreateReviewModal.tsx"
Cohesion: 0.29
Nodes (6): CreateReviewFormValues, CreateReviewModal(), CreateReviewModalProps, createReviewSchema, Label, labelVariants
...
### Community 72 - "RequestDetailContent.tsx"
Cohesion: 0.48
Nodes (5): RequestDetailContent(), useCanPropose(), useProposals(), ProposalList(), StatusGuide()

### Community 73 - "ProposalService"
Cohesion: 0.13
Nodes (7): ProposalService, IProposalWithSeller, ICreateProposalRequest, IUpdateProposalRequest, EditProposalFormProps, EditProposalModalProps, ProposalItemProps
...
Cohesion: 0.16
Nodes (18): useCreateRequestSubscription(), useUpdateRequestSubscription(), ICategoryPreference, INewRequestsPreference, NotificationScope, channelsForEnabled(), CategoryChipsSelect(), CategoryChipsSelectProps (+10 more)
...
Cohesion: 0.29
Nodes (7): useCities(), citySchema, searchCitiesResponseSchema, LocationService, ICity, ISearchCitiesDto, ISearchCitiesResponse
...
Cohesion: 0.18
Nodes (11): useMarkAllNotificationsRead(), useMarkNotificationRead(), useNotifications(), useUnreadCount(), NotificationService, mapNotificationFilters(), ALL_NOTIFICATION_CHANNELS, useProfiles() (+3 more)
...
Cohesion: 0.14
Nodes (14): generateMetadata(), inter, messagesByLocale, Props, RootLayout(), Providers(), ProvidersProps, Locale (+6 more)
...
### Community 173 - "drawer.tsx"
Cohesion: 0.25
Nodes (6): DrawerContent, DrawerDescription, DrawerFooter(), DrawerHeader(), DrawerOverlay, DrawerTitle

### Community 174 - "sitemap.ts"
Cohesion: 0.62
Nodes (6): getBlogEntries(), getRequestEntries(), localizedUrl(), sitemap(), sitemapEntry(), STATIC_ROUTES

### Community 176 - "CompleteProposalModal.tsx"
Cohesion: 0.60
Nodes (3): useCompleteProposal(), CompleteProposalModal(), CompleteProposalModalProps

### Community 177 - "RejectProposalModal.tsx"
Cohesion: 0.60
Nodes (3): useRejectProposal(), RejectProposalModal(), RejectProposalModalProps

### Community 178 - "input-otp.tsx"
Cohesion: 0.40
Nodes (4): InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot

### Community 179 - "RequestSidebar.tsx"
Cohesion: 0.67
Nodes (3): IRequestBuyer, RequestSidebar(), RequestSidebarProps

### Community 180 - "useQueryPagination.ts"
Cohesion: 0.50
Nodes (3): DEFAULT_INITIAL_FILTERS, UseQueryPaginationOptions, UseQueryPaginationReturn
...
- **Why does `dependencies` connect `dependencies` to `@radix-ui/react-avatar`, `@radix-ui/react-collapsible`, `@radix-ui/react-label`, `@lingui/react`, `@radix-ui/react-menubar`, `@radix-ui/react-switch`, `@radix-ui/react-toast`, `@radix-ui/react-tooltip`, `chart.tsx`, `react-day-picker`, `@radix-ui/react-tabs`, `package.json`, `input-otp`, `class-variance-authority`, `clsx`, `embla-carousel-react`, `@hookform/resolvers`, `@lingui/core`, `lucide-react`, `next`, `next-auth`, `next-themes`, `@radix-ui/react-accordion`, `@radix-ui/react-alert-dialog`, `@radix-ui/react-aspect-ratio`, `@radix-ui/react-checkbox`, `cmdk`, `@radix-ui/react-context-menu`, `@radix-ui/react-dialog`, `@radix-ui/react-dropdown-menu`, `@radix-ui/react-hover-card`, `date-fns`, `@radix-ui/react-navigation-menu`, `@radix-ui/react-progress`, `@radix-ui/react-radio-group`, `@radix-ui/react-separator`, `@radix-ui/react-slider`, `@radix-ui/react-toggle`, `@radix-ui/react-toggle-group`, `react-resizable-panels`, `react-toastify`, `recharts`, `sonner`, `tailwind-merge`, `tailwindcss-animate`, `@tanstack/react-query`, `vaul`, `@vercel/analytics`, `zod`, `zustand`, `immer`?**
  _High betweenness centrality (0.184) - this node is a cross-community bridge._
- **Why does `react` connect `chart.tsx` to `UserRequestsList.tsx`, `sidebar.tsx`, `use-toast.ts`, `universal-pagination.tsx`, `dependencies`?**
  _High betweenness centrality (0.174) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `AdminContent.tsx`, `ProposalDetailContent.tsx`, `review/index.ts`, `form.tsx`, `UserRequestsList.tsx`, `routes.ts`, `sidebar.tsx`, `dialog.tsx`, `CreateRequestForm.tsx`, `button.tsx`, `use-toast.ts`, `toggle-group.tsx`, `ProposalItem.tsx`, `universal-pagination.tsx`, `loading.tsx`, `city-combobox.tsx`, `chart.tsx`, `SupportContent.tsx`, `menubar.tsx`, `EditProposalForm.tsx`, `context-menu.tsx`, `breadcrumbs.tsx`, `navigation-menu.tsx`, `drawer.tsx`, `AcceptProposalModal.tsx`, `input-otp.tsx`, `CreateReviewModal.tsx`, `RequestSubscriptionModal.tsx`, `notification/index.ts`?**
