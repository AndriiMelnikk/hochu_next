      ...
      <div className="grid lg:grid-cols-2 gap-0 max-w-6xl mx-auto bg-card rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8 lg:p-12">
          <div className="space-y-2 mb-8">
            <h1 className="text-3xl font-bold text-card-foreground">{t('auth.register.title')}</h1>
            ...
            <div className="space-y-4 pt-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">{t('auth.register.benefit1.description')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">{t('auth.register.benefit2.description')}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/80 text-sm">{t('auth.register.benefit3.description')}</p>
                </div>
              </div>
            </div>
          </div>
