        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-muted-foreground mb-12">
              У Hochu ми серйозно ставимося до захисту вашої конфіденційності. Ця політика пояснює,
              які дані ми збираємо, як їх використовуємо та захищаємо.
            </p>
            ...
            <div className="mt-12 p-8 bg-primary/5 rounded-2xl border border-primary/20">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                своїми правами, будь ласка, зв&apos;яжіться з нами:
              </p>
