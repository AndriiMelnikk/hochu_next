              ...
              <div className="bg-card rounded-2xl p-6 shadow-md border border-border">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-3xl font-bold text-primary">{proposalData.price} грн</div>
                  </div>
                </div>
              ...
              <div className="bg-muted/30 rounded-2xl p-6 border border-border">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground">
                    ...
                    <span>{proposalData.request.totalProposals} пропозицій</span>
                  </div>
                </div>
              </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="font-semibold">
                            {proposalData.buyer.memberSince} року
                          </span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 border-t">
                      <div className="flex gap-2">
                        <Textarea placeholder="Написати коментар..." className="min-h-[80px]" />
