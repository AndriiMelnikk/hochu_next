...
export const sellerAchievements: Achievement[] = [
  ...
  {
    id: 'fast_responder',
    name: 'Блискавична відповідь',
    description: 'Відповідайте за 5 хв 10 разів',
    icon: '⚡',
    rarity: 'rare',
  },
  {
  ...
  },
  {
    id: 'price_master',
    name: 'Майстер цін',
    description: '50% пропозицій прийнято',
    icon: '💰',
    rarity: 'rare',
  },
];
...
export const buyerAchievements: Achievement[] = [
  ...
  {
    id: 'big_spender',
    name: 'Великий покупець',
    description: 'Витратили 100k+ грн',
    icon: '💎',
    rarity: 'legendary',
  },
  {
    id: 'explorer',
    name: 'Дослідник',
    description: 'Замовлення в 10+ категоріях',
    icon: '🗺️',
    rarity: 'epic',
  },
];
