...
export function createDefaultSections(): ArticleSectionData[] {
  return [
    {
      type: 'intro',
      content: "Створення якісного запиту на послугу — це перший крок до успішного співробітництва з виконавцями. У цій статті ми розповімо, як правильно сформулювати ваші потреби, щоб отримати найкращі пропозиції."
    },
    {
      type: 'tip',
    ...
    },
    {
      ...
      content: "Прозоре зазначення бюджету допомагає виконавцям оцінити реалістичність проєкту та запропонувати адекватні умови. Не бійтеся вказувати діапазон, якщо точна сума ще не визначена.",
      icon: "DollarSign"
    },
    {
      type: 'info',
      title: "3. Додайте візуальні матеріали",
      content: "Фотографії, ескізи, приклади робіт — все це значно покращує розуміння вашого запиту. Зображення допомагають уникнути непорозумінь та забезпечують кращу комунікацію.",
      icon: "ImageIcon"
    },
    {
      type: 'info',
      title: "4. Опишіть контекст",
      content: "Поясніть, для чого потрібна ця послуга, які цілі ви переслідуєте. Це допоможе виконавцям краще зрозуміти ваші потреби та запропонувати оптимальні рішення.",
      icon: "FileText"
    },
    {
      type: 'tip',
      title: "5. Вкажіть критерії оцінки",
      content: "Що для вас найважливіше: швидкість, якість, ціна чи щось інше? Визначте пріоритети, щоб виконавці могли підготувати пропозиції, що відповідають вашим очікуванням.",
      icon: "Info"
    },
    {
      type: 'conclusion',
      content: "Якісний запит — це запорука успішного співробітництва. Витративши трохи часу на детальний опис ваших потреб, ви заощадите набагато більше часу на пошуки підходящого виконавця та уточнення деталей."
    },
    {
      type: 'tips-list',
